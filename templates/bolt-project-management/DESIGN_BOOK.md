# Bolt Project Management Design Book

## Direction

Project management tool. The interface is designed as a premium product surface rather than a generic landing page. It emphasizes immediate utility, realistic operating content, and a visual system that can stretch into a production app.

## Palette

- Background: `#f5f9ff`
- Surface: `#ffffff`
- Secondary surface: `#e3efff`
- Text: `#11213a`
- Muted text: `#64748b`
- Accent: `#2563eb`
