# Bolt Reservation System Design Book

## Direction

Restaurant booking. The interface is designed as a premium product surface rather than a generic landing page. It emphasizes immediate utility, realistic operating content, and a visual system that can stretch into a production app.

## Palette

- Background: `#fffaf5`
- Surface: `#ffffff`
- Secondary surface: `#f5e7dc`
- Text: `#2a1517`
- Muted text: `#7a6460`
- Accent: `#8a1538`
- Secondary accent: `#d56a4f`
- Direction: Warm white and burgundy
