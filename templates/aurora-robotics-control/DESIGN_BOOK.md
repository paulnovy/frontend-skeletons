# Aurora Robotics Control Design Book

## Direction

Robotics fleet management. The interface is designed as a premium product surface rather than a generic landing page. It emphasizes immediate utility, realistic operating content, and a visual system that can stretch into a production app.

## Palette

- Background: `#061114`
- Surface: `#0d1d22`
- Secondary surface: `#12333a`
- Text: `#ecfeff`
- Muted text: `#9cc7cc`
- Accent: `#22d3ee`
- Secondary accent: `#14b8a6`
- Direction: Dark and cyan
