# Prism Compliance Hub Design Book

## Skeleton name and project type
Prism Compliance Hub is a premium compliance management workspace skeleton in the GRC category.

## Intended audience
Compliance officers, internal audit teams, and regulated SaaS operations leaders.

## Main user problem solved
Makes audit readiness measurable by joining policy cards, trails, exceptions, and risk scoring in one review surface.
...
The visual system uses the requested white/navy palette and restrained agency-style spacing. The design avoids generic dashboard filler by presenting realistic content, strong information hierarchy, and product surfaces that can be adapted into a live prototype.

## Color usage description
Primary accent: `#193b68`. Secondary accent: `#2f6fa7`. Background color: `#f7f9fc`. Accent colors are reserved for progress, state, active controls, and navigational emphasis.
