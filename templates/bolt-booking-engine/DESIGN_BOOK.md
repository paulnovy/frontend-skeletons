...
Service booking system. The interface is designed to feel premium, credible, and immediately usable while staying adaptable for a real product team.

## Palette

- Background: `#f7f7ff`
- Surface: `#ffffff`
- Secondary surface: `#eeedff`
- Text: `#17142e`
- Muted text: `#68647d`
- Accent: `#5b4bff`
