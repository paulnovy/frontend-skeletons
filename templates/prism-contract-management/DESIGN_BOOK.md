# Prism Contract Management Design Book

## Skeleton name and project type
Prism Contract Management is a premium contract lifecycle management application skeleton in the LegalTech category.

## Intended audience
Legal operations teams, sales leaders, procurement, and finance reviewers.

## Main user problem solved
Replaces scattered document threads with a clear lifecycle view from clause drafting to signature and renewal.
...
Primary accent: `#1d4ed8`. Secondary accent: `#38bdf8`. Background color: `#f6f9ff`. Accent colors are reserved for progress, state, active controls, and navigational emphasis.
