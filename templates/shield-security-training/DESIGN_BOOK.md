# Shield Security Training Design Book

## Skeleton name and project type
Shield Security Training is a premium security training and phishing simulation portal skeleton in the Security Awareness category.

## Intended audience
Security awareness teams, HR enablement, compliance managers, and department leads.

## Main user problem solved
Turns training status, simulation results, and risk behavior into a practical manager-facing dashboard.
...
The visual system uses the requested white/red accent palette and restrained agency-style spacing. The design avoids generic dashboard filler by presenting realistic content, strong information hierarchy, and product surfaces that can be adapted into a live prototype.

## Color usage description
Primary accent: `#dc2626`. Secondary accent: `#f97316`. Background color: `#fffafa`. Accent colors are reserved for progress, state, active controls, and navigational emphasis.
