# Bolt Invoice Generator Design Book

## Direction

Invoice tool. The interface is designed as a premium product surface rather than a generic landing page. It emphasizes immediate utility, realistic operating content, and a visual system that can stretch into a production app.

## Palette

- Background: `#f6fbf7`
- Surface: `#ffffff`
- Secondary surface: `#e4f6e8`
- Text: `#102217`
- Muted text: `#627466`
- Accent: `#16a34a`
- Secondary accent: `#86c75a`
- Direction: White and green
