# Spark Creator Economy Design Book

## Direction

Creator monetization platform. The interface is designed to feel premium, credible, and immediately usable while staying adaptable for a real product team.

## Palette

- Background: `#100817`
- Surface: `#1b1024`
- Secondary surface: `#271435`
- Text: `#fff7ff`
- Muted text: `#cdb8d9`
- Accent: `#ff4fd8`
- Secondary accent: `#ff9d2e`
