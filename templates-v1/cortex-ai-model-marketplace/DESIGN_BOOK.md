# Cortex AI Model Marketplace Design Book

## Direction

AI model marketplace. The interface is designed as a premium product surface rather than a generic landing page. It emphasizes immediate utility, realistic operating content, and a visual system that can stretch into a production app.

## Palette

- Background: `#0c0718`
- Surface: `#171024`
- Secondary surface: `#241638`
- Text: `#faf5ff`
- Muted text: `#c7b7da`
- Accent: `#a855f7`
- Secondary accent: `#6366f1`
- Direction: Dark and purple
