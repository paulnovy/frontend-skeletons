...
Lightweight CRM. The interface is designed as a premium product surface rather than a generic landing page. It emphasizes immediate utility, realistic operating content, and a visual system that can stretch into a production app.

## Palette

- Background: `#f7f7ff`
- Surface: `#ffffff`
- Secondary surface: `#ececff`
- Text: `#17142e`
- Muted text: `#696783`
- Accent: `#4f46e5`
- Secondary accent: `#8b5cf6`
- Direction: White and indigo
