# Aurora Generative Art Design Book

## Direction

AI art tool. The interface is designed as a premium product surface rather than a generic landing page. It emphasizes immediate utility, realistic operating content, and a visual system that can stretch into a production app.

## Palette

- Background: `#090b16`
- Surface: `#111827`
- Secondary surface: `#1b2350`
- Text: `#f7fbff`
- Muted text: `#aeb8d2`
- Accent: `#8b5cf6`
- Secondary accent: `#22d3ee`
- Direction: Dark multi-color gradient
