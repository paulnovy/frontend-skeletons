# Shield Access Management Design Book

## Skeleton name and project type
Shield Access Management is a premium iam and sso administration console skeleton in the Identity category.

## Intended audience
IT administrators, security operations, HRIS owners, and SaaS platform teams.

## Main user problem solved
Unifies identity visibility with day-to-day access operations so admins can spot drift and enforce policy.
...
The visual system uses the requested white/blue-gray palette and restrained agency-style spacing. The design avoids generic dashboard filler by presenting realistic content, strong information hierarchy, and product surfaces that can be adapted into a live prototype.

## Color usage description
Primary accent: `#475569`. Secondary accent: `#2563eb`. Background color: `#f8fafc`. Accent colors are reserved for progress, state, active controls, and navigational emphasis.
