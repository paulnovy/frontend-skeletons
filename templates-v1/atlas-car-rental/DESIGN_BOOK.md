# Atlas Car Rental Design Book

## Direction

Car rental platform. The interface is designed as a premium product surface rather than a generic landing page. It emphasizes immediate utility, realistic operating content, and a visual system that can stretch into a production app.

## Palette

- Background: `#f6f9fc`
- Surface: `#ffffff`
- Secondary surface: `#e8f0f7`
- Text: `#122033`
- Muted text: `#66758a`
- Accent: `#2f6f9f`
- Secondary accent: `#89a9c7`
- Direction: White and steel blue
