# Pulse Mental Health Design Book

## Skeleton name and project type
Pulse Mental Health is a premium mental health support and journaling app skeleton in the Health & Wellness category.

## Intended audience
Consumers, care coordinators, therapists, and digital health product teams.

## Main user problem solved
Creates a calm daily care surface that makes mood patterns, sessions, and writing practices easier to sustain.
...
The visual system uses the requested soft purple/white palette and restrained agency-style spacing. The design avoids generic dashboard filler by presenting realistic content, strong information hierarchy, and product surfaces that can be adapted into a live prototype.

## Color usage description
Primary accent: `#8b5cf6`. Secondary accent: `#c084fc`. Background color: `#fbf8ff`. Accent colors are reserved for progress, state, active controls, and navigational emphasis.
