# Aurora Product Showcase Design Book

## Direction

This skeleton is designed as a sleek, premium, focused experience for a single product showcase page. The visual system uses white and minimal with a bold product color accent and keeps the first screen immediately useful rather than promotional.
...
- Primary accent: `#ff4f3d`
- Secondary accent: `#111827`
- Background: `#ffffff`
- Text: `#14151a`
- Surface: `#f7f7f8`
